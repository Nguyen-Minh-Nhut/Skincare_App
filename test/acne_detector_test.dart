...
void main() {
  group('shouldKeepAcneDetection', () {
    test('keeps a strong YOLO detection when classifier disagrees', () {
      expect(
  ...
  group('shouldRunAcneClassifier', () {
    test('classifies only detections in [0.08, 0.15)', () {
      ...
      expect(shouldRunAcneClassifier(detectorConfidence: 0.15), isFalse);
      expect(shouldRunAcneClassifier(detectorConfidence: 0.90), isFalse);
    });
  });
